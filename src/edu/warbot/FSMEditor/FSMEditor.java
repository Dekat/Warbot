...
public class FSMEditor {
	...
	public FSMEditor() {
		...
		ModeleState state1 = new ModeleState("State1", Configuration.PLAN[1]);
		ModeleState state2 = new ModeleState("State2", Configuration.PLAN[0]);
		ModeleState state3 = new ModeleState("State3", Configuration.PLAN[0]);
